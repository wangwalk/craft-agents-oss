...
type ApiToChannelMapKeys = Exclude<
  ...
  | 'showOpenConnectorConsole' // direct local IPC — owns a native WebContentsView
  | 'updateOpenConnectorConsoleBounds'
  | 'hideOpenConnectorConsole'
  | 'destroyOpenConnectorConsole'
> | BrowserPaneKeys
