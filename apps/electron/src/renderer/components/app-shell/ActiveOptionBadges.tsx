...
export interface ActiveOptionBadgesProps {
  ...
  // ── State/status badge props are kept for compatibility; the badge is hidden in this fork. ──
...
export function ActiveOptionBadges({
  ...
  // Show the stacking container when there are labels. Workflow state badges are hidden in this fork.
