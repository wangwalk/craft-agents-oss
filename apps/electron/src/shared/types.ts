...
export interface ElectronAPI {
  ...
  requestOpenConnectorRuntimeJson(workspaceId: string, sourceSlug: string, request: { method: 'PUT' | 'DELETE'; path: string; body?: unknown }): Promise<{ success: boolean; data?: unknown; status?: number; error?: string }>
